...
export default function TV() {
  ...
  async function getData(pageNum = 1, type = "popular") {
    let { data } = await axios.get(`https://api.themoviedb.org/3/tv/popular?api_key=8613e4e1776af4e8633cc311d67b3e09&language=en-US&page=${pageNum}`)
  ...
  async function search(e) {
    ...
    if (value != '') {
      let { data } = await axios.get(`https://api.themoviedb.org/3/search/tv?api_key=8613e4e1776af4e8633cc311d67b3e09&language=en-US&query=${value}&page=1&include_adult=false`)
      setMoviesList(data.results)
    } else {
      getData()
    }
